// @ts-nocheck
import WorkspaceSubscription from "../../server/models/WorkspaceSubscription.js";
import { WebsiteCreditsRequest } from "../models/WebsiteCreditsRequest";
...
export const approveCreditsRequest = async (req, res) => {
  try {
    ...
    subscription.creditsLimit =
      Number(subscription.creditsLimit || 0) + Number(creditRequest.requestedCredits || 0);
