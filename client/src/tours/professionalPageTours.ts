...
const PROFESSIONAL_PAGE_TOURS: ProfessionalTourRoute[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { selector: '[data-tour="professional-quick-links"]', title: "Quick Links", description: "Open Listings, Website Builder, Tenant Companies, Meeting Rooms, Customer Support, Visitor Management, Organization, or Calendar directly." },
