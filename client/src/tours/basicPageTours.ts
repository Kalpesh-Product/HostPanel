...
const BASIC_PAGE_TOURS: TourRoute[] = [
  ...
  },
  {
    ...
    steps: [
      { selector: '[data-tour="admin-housekeeping-tabs"]', title: "Task views", description: "Daily Scheduled Tasks lists your recurring plan, Booking-Based Tasks are generated automatically from room reservations, Task History archives completed work, and Onboard Staff / Housekeeping Members / Staff Performance manage your team." },
      ...
      { selector: '[data-tour="admin-housekeeping-add-btn"]', title: "Create work", description: "Add Scheduled Task plans a cleaning job with a time, assignee, and a Repeats Daily toggle — it keeps running every day unchanged until you edit it here. Onboard new staff and view performance from their own tabs." },
      { selector: '[data-tour="admin-housekeeping-table"]', title: "Task board", description: "Tasks show area, floor, assignee, start time, and status with edit or cancel actions; anything left unfinished from a prior day is flagged Overdue instead of disappearing.", side: "top" },
    ],
