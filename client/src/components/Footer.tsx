...
const HostFooter = () => {
  ...
  const goToHostsPrivacy = () => {
      window.open("https://nomad.wono.co/privacy", "_blank");
  };
  const goToHostsTC = () => {
   window.open("https://host.wono.co/terms-and-conditions", "_blank");
  };
  const goToHostsContentCopyright = () => {
    window.open("https://host.wono.co/content-and-copyright", "_blank");
  };
  const goToHostsContentUseRemoval = () => {
    window.open("https://host.wono.co/content-use-removal", "_blank");
  };
  const goToAboutPage = () => {
    window.open("https://host.wono.co/about", "_black");
  };
  const goToCareerPage = () => {
    window.open("https://host.wono.co/career", "_black");
  };
  const goToFaqPage = () => {
    window.open("https://host.wono.co/faq", "_black");
  };
  const goToHostsContact = () => {
    window.open("https://host.wono.co/contact", "_blank");
  };
  ...
  const footerSections = [
    {
      heading: "Services",
      links: [
        { name: "About", link: goToAboutPage },
        { name: "Career", link: goToCareerPage },
        { name: "FAQs", link: goToFaqPage },
        // {
    ...
    },
    {
      ...
      links: [
        ...
        { name: "Contact", link: goToHostsContact },
        // {
