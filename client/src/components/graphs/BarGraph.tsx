...
interface BarGraphProps {
  ...
  firstParam?: { title: string; data: string | number };
  secondParam?: { title: string; data: string | number };
  year?: boolean;
  departments?: string[];
  singleParam?: boolean;
  doubleParam?: boolean;
...
const BarGraph = ({
  ...
  return (
    <div className="bg-white rounded-md pt-2">
      ...
      {customLegend && firstParam && secondParam && (
      ...
      {isChartLoading ? (
        ...
        <div className="w-full" ref={containerRef as any}>
          <Chart
            key={chartKey}
