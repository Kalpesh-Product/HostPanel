...
export default function LogoAdjustModal({ open, imageSrc, onClose, onSave, saving }: LogoAdjustModalProps) {
  ...
  const handleSave = async () => {
    ...
    const blob = await getCroppedLogoBlob(imageSrc, croppedAreaPixels);
    onSave(blob);
  };
  ...
  return (
    <MuiModal open={open} onClose={handleClose} title="Adjust Company Logo">
      <div className="flex flex-col gap-4">
        ...
        <p className="text-center text-[12px] text-slate-500">
          Drag to reposition and use the slider to zoom. This is how your logo will appear on the left side of the header.
        </p>
