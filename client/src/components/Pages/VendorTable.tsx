...
const VendorTable = () => {
  ...
  const {
    ...
    queryFn: async function () {
      const response = await axios.get(`/api/vendors/get-vendors/${department._id}`);
      ...
      cellRenderer: (params: any) => {
        ...
        return !isEmpty ? (
          <span
            ...
            onClick={() =>
              navigate(`/app/dashboard/${departmentName}-dashboard/data/vendor/${params.data.vendorName}`, {
                state: params.data,
              })
            }
          >
