                ...
                <div className="overflow-y-auto flex-1 p-5 space-y-4">
                  ...
                  <div>
                    ...
                    <div className="rounded-xl border border-slate-100 bg-slate-50 p-3.5">
                      <p className="text-[12px] font-medium leading-5 text-slate-700">{selectedReview.description || "No description provided."}</p>
                    </div>
                  </div>
                  ...
                  {selectedReview.reviewLink && (
                    <div>
                      <p className="text-[9px] font-pmedium uppercase tracking-widest text-slate-400 mb-1.5">Review Link</p>
                      <a href={selectedReview.reviewLink} target="_blank" rel="noreferrer"
                        className="text-[12px] font-semibold text-blue-600 underline break-all hover:text-blue-800"
                      >{selectedReview.reviewLink}</a>
                    </div>
                  )}
