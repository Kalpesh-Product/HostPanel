...
export const DEFAULT_SECTION_ROUTES: Record<string, string> = {
  ...
  "printouts": "/common-modules/printouts",
  ...
  "printout-management": "/department-accesses/administration-department/printouts",
...
const SECTION_FALLBACKS: Record<SectionType, WorkspaceModuleSection> = {
  "common-modules": {
    ...
    items: [
      ...
      { id: "printouts", label: "Printouts", route: "/common-modules/printouts", implemented: true, unlockedInWorkspace: true },
    ...
    const syncUpgradeRequest = async () => {
      ...
      try {
        ...
        if (
          ...
          String(parsed.requestedPlan).toLowerCase() !== currentPlan
        ) {
...
const ModuleCardsLanding = ({ section }: { section?: SectionType }) => {
  ...
  return (
    <PageFrame>
      ...
      {isUpgradeModalOpen ? (
        <UpgradePlanModal
          currentPlan={planLabel as PlanType}
