...
export const DEFAULT_SECTION_ROUTES: Record<string, string> = {
  ...
  "printout-management": "/common-modules/printouts",
...
const SECTION_FALLBACKS: Record<SectionType, WorkspaceModuleSection> = {
  "common-modules": {
    ...
    items: [
      ...
      { id: "printout-management", label: "Printouts", route: "/common-modules/printouts", implemented: true, unlockedInWorkspace: true },
