...
export default function TenantCompanyDetailPage() {
  ...
  // A company has exactly one Admin — that Admin doubles as the company's
  // primary contact / manager slot (managerEmployeeId), distinct from
  // per-department Managers above.
    ...
    <>
        ...
        <PageFrame>
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-3">
              <button onClick={() => navigate('/department-accesses/sales-department/tenant-companies')}
                    ...
                    <div className="bg-white rounded-2xl border border-slate-100 p-5 shadow-sm">
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          {existingAdminEmployee && <p className="text-[10px] text-slate-500 mt-0.5">{existingAdminEmployee.email}</p>}
                        </div>
      ...
      {mgrModal && (
        <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center sm:p-4 bg-slate-900/40 backdrop-blur-sm">
          <div className="bg-white/95 backdrop-blur-xl w-full sm:max-w-md h-auto rounded-t-[32px] sm:rounded-[32px] shadow-2xl overflow-hidden max-h-[92vh] flex flex-col">
            <div className="flex items-center justify-between p-5 border-b border-slate-100">
              <h3 className="text-sm font-black text-slate-900">Change Admin</h3>
