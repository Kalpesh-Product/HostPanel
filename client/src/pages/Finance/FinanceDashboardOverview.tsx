  ...
  return (
    <div className="p-4 flex flex-col gap-5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <TeamLiveStatusCard department="finance" viewAllRoute="/finance/billing-payments" />

        <DepartmentVisitorsCard department="finance" title="Finance Visitors" />

        <SectionCard title="Pending Security Deposits" linkLabel="View all" linkRoute="/finance/billing-payments">
      ...
      <WidgetSection layout={4} title="Quick Links" border normalCase>
        <QuickLink icon={Wallet} label="Expenses & Budget" description="Departmental budgets & spend" route="/finance/expenses-budget" color="#f59e0b" />
        <QuickLink icon={Receipt} label="Billing & Payments" description="Deposits, bookings & payroll" route="/finance/billing-payments" color="#1E3D73" />
        <QuickLink icon={Calculator} label="Accounting" description="Ledgers & reconciliation" route="/finance/accounting" color="#7c3aed" />
      </WidgetSection>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <SectionCard title="Security Deposits" linkLabel="View all" linkRoute="/finance/billing-payments">
        ...
        <SectionCard title="Top Payroll Earners" linkLabel="View all" linkRoute="/finance/billing-payments">
