...
const workspaceSchema = new mongoose.Schema(
  {
    ...
    payrollSettings: {
      ...
      payslipTemplateLockedAt: { type: Date, default: null },
      payslipTemplateLockedBy: { type: mongoose.Schema.Types.ObjectId, ref: "HostUser", default: null },
    },
    attendanceGeofence: {
    ...
    attendanceSettings: {
      weeklyWorkingHours: { type: Number, default: null, min: 1, max: 168 },
      workingHoursStart: { type: String, default: null },
      workingHoursEnd: { type: String, default: null },
      breakDurationMinutes: { type: Number, default: null, min: 0, max: 480 },
      lateMarkAfter: { type: String, default: null },
      halfDayMarkAfter: { type: String, default: null },
      shifts: {
        type: [{
          ...
          breakDurationMinutes: { type: Number, required: true, min: 0, max: 480 },
          weeklyWorkingHours: { type: Number, required: true, min: 1, max: 168 },
          lateMarkAfter: { type: String, default: null },
          halfDayMarkAfter: { type: String, default: null },
        }],
        default: [],
