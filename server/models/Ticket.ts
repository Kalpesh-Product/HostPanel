...
const ticketSchema = new Schema<ITicket>(
    {
        ...
        acceptedByUserId: { type: Schema.Types.ObjectId, ref: "User", default: null, index: true },
        ...
        repairLogAssignedToUserId: { type: Schema.Types.ObjectId, ref: "User", default: null, index: true },
