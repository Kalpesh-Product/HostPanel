...
export const getLeads = async (req, res, next) => {
    try {
        ...
        const leads = await axios.get(`https://wononomadsbe.vercel.app/api/company/leads?companyId=${companyId}`);
...
export const updateLeads = async (req, res, next) => {
    try {
        ...
        const leads = await axios.patch(`https://wononomadsbe.vercel.app/api/company/update-lead`, req.body);
        if (leads.status !== 200)
